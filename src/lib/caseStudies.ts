export type CaseStudy = {
  ...
  // Used on the case study detail page (and can also be used for card backgrounds on the homepage)
  heroImage?: string;

  // Optional: if you ever want a different image for homepage cards than the hero image
  cardImage?: string;
};
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    // cardImage: "/case-studies/forecasting-controls.jpg",
  },

  {
    ...
    // cardImage: "/case-studies/approval-cycle-time.jpg",
  },

  {
    ...
    // cardImage: "/case-studies/cross-functional-realignment.jpg",
  },

  {
    ...
    // cardImage: "/case-studies/lease-up-concessions.jpg",
  },
];
